...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h4 class="mt-4">Tambah data pengeluaran</h4>
                </div>
                <div class="col-lg-12">
                    <hr>
                    <?php
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" tep="any" min="0" type="number" name="stok" id="txt-stok" value="<?php echo $datab['stokb']; ?>" readonly required>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <label>Sisa</label>
                                            <input class="form-control" tep="any" min="0" type="text" name="sisa" id="txt-sisa" readonly required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Jumlah yang diambil</label>
                                    <input class="form-control" onkeyup="sums();" onkeypress="return hanyaAngka(event)" tep="any" min="0" type="number" name="jumlah" id="txt-jumlah" required>
                                </div>
                                <div class="form-group">
                                    <label>Jenis Kebutuhan</label>
                                    <select class="form-control" name="kepentingan" id="kepentingan" required>
                                        <option value="">Pilih Kategori</option>
                                        <option value="Pameran Internasional">Pameran Internasional</option>
                                        <option value="Pameran Nasional">Pameran Nasional</option>
                                        <option value="Pameran Regional">Pameran Regional</option>
                                        <option value="Road Show Tim Marcomm">Road Show Tim Marcomm</option>
                                        <option value="Road Show Tim Eksternal">Road Show Tim Eksternal</option>
                                        <option value="Kunjungan Sekolah ke UII">Kunjungan Sekolah ke UII</option>
                                        <option value="Event Umum di UII">Event Umum di UII</option>
                                        <option value="Kebutuhan Tim PMB">Kebutuhan Tim PMB</option>
                                        <option value="Give Away Tim Medsos">Give Away Tim Medsos</option>
                                        <option value="Riset Direktorat Pemasaran">Riset Direktorat Pemasaran</option>
                ...
                $kepentingan = trim(mysqli_real_escape_string($conn, @$_POST['kepentingan']));
                $tambah = @$_POST['tambah'];
                ...
                ?>
                        <script type="text/javascript">
                            alert("pengeluaran melebihi data yang ada!");
                        </script>
                    <?php
                    } else {
                        $sqltambah = mysqli_query($conn, "INSERT INTO tb_transaksi VALUES ('$kd_transaksi','$tgl_transaksi','$keterangan','$jumlah','$nama','$stok','$id_user','$kd_barang','$kepentingan')");
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td align="center">
                                                                    <p>
                                                                        <a href="tambah_data_pengeluaran.php?idbrg=<?php echo $data['kd_barang'] ?>" class="btn btn-primary">Pilih</a>
                                                                </td>
                                                            </tr>
                                                        <?php
                                                        }
