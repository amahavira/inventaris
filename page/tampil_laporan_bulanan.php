...
<div id="layoutSidenav_content">
  <main>
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <h4 class="mt-4">Laporan Bulanan</h4>
        </div>
        <div class="col-12">
          <hr>
          <div class="col-4">
            <form action="" method="post">
              <div class="form-group">
                ...
                <input type="text" value="<?php echo date('m Y'); ?>" name="tanggalb" class="tanggal" />
              </div>
              <div class="form-group">
          ...
          <div class="card-body" id="div1">
            <div class="table-responsive">
              ...
              $tgl = @$_POST['tanggalb'];
              ?>
              <h4 align="center">Laporan Bulanan</h4></br>
              <h5 align="center">Bulan <?php echo $tgl; ?></h5>
              <hr>
              <table width="100%" border="1" style="border-collapse: 1;" cellspacing="0">
                ...
                <tbody>
                  ...
                  if (isset($btn)) {
                    $sql = mysqli_query($conn, "SELECT * FROM tb_barang,tb_user,tb_transaksi WHERE tb_barang.kd_barang = tb_transaksi.kd_barang and tb_user.id_user = tb_transaksi.id_user and tb_transaksi.tgl_transaksi like '%$tgl%'");
                  } else {
                    $sql = mysqli_query($conn, "SELECT * FROM tb_barang,tb_user,tb_transaksi WHERE tb_barang.kd_barang = tb_transaksi.kd_barang and tb_user.id_user = tb_transaksi.id_user and tb_transaksi.tgl_transaksi like '%$tgls%'");
                  }
