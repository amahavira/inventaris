...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h4 class="mt-4">Laporan Range Tanggal</h4>
                </div>
                <div class="col-12">
                    <hr>
                    <div class="col-4">
                        <form action="" method="post">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly value="<?php echo date('d m Y'); ?>" name="tanggal1" class="tanggal" />
                                </div>
                                <span class="ml-2 mr-2 font-weight-bold"> - </span>
                                <div class="form-group">
                                    <label for="tanggal2">Tanggal</label>
                                    <input type="text" readonly value="<?php echo date('d m Y'); ?>" name="tanggal2" class="tanggal" />
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="card-header">
                        <i class="fa fa-table"></i> Laporan Range Tanggal
                    </div>
                    <div class="card-body" id="div1">
                        <div class="table-responsive">
                            ...
                            $tgls = date('d m Y');
                            ?>
                            <h4 align="center">Laporan Range Tanggal</h4></br>
                            <h5 align="center">Tanggal <?php echo $tgl1; ?> Sampai <?php echo $tgl2; ?></h5>
                            <hr>
                            <table width="100%" border="1" style="border-collapse: 1;" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    if (isset($btn)) {
                                        $sql = mysqli_query($conn, "SELECT * FROM tb_barang,tb_user,tb_transaksi WHERE tb_barang.kd_barang = tb_transaksi.kd_barang and tb_user.id_user = tb_transaksi.id_user and tb_transaksi.tgl_transaksi between '$tgl1' and '$tgl2'");
                                    } else {
